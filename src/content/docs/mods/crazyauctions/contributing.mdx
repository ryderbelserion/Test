---
title: Contributing
description: Contribute to CrazyAuctions!

slug: mods/crazyauctions/contributing
---
...
<Aside type="tip">
    Contributions to CrazyAuctions is a much easier process if you discuss it in Discord *before* making a pull request.
...
#### Process
<Steps>
    1. git clone https://github.com/Crazy-Crew/CrazyAuctions.git
